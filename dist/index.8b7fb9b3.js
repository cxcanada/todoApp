...
_routeDefault.default("/");

},{"./routes/route":"Xo3Ut","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"Xo3Ut":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"../pages/home":"ibbKS","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV","../pages/todo":"gfP4p"}],"ibbKS":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const homePage = function() {
    ...
    const h1 = _headerDefault.default('Peace of Cake');
    const linkElm = _linkDefault.default('TO DO', '/todo');
    const tag = _taglineDefault.default("Not As Hard As You Thought");
    const brandLogo = _logoDefault.default("ui-logo");
...
},{"../components/ui/header":"9iGIZ","../components/ui/link":"hFEwy","../components/icons/logo":"izkzg","../components/ui/tagline":"lEXnU","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"9iGIZ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const header = function(title = "ui h1 header", className = "ui-heading") {
    ...
    const element = _makeElementDefault.default(templateString);
    return element;
};
exports.default = header;

},{"../../utils/makeElement":"8ZxEo","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"8ZxEo":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const onRequestPage = function(evt) {
    evt.preventDefault();
    _routeDefault.default(evt.currentTarget.dataset.path);
    return false;
};
const link = function(title = 'ui link', path = '/', className = 'ui-link') {
    ...
    const elem = _makeElementDefault.default(templateString);
    elem.addEventListener('click', onRequestPage);
    return elem;
};
exports.default = link;

},{"../../utils/makeElement":"8ZxEo","../../routes/route":"Xo3Ut","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"izkzg":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _makeElement = require("../../utils/makeElement");
var _makeElementDefault = parcelHelpers.interopDefault(_makeElement);
...
`;
    elem = _makeElementDefault.default(templateString);
    return elem;
};
exports.default = logo;

},{"@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV","../../utils/makeElement":"8ZxEo"}],"lEXnU":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _makeElement = require("../../utils/makeElement");
var _makeElementDefault = parcelHelpers.interopDefault(_makeElement);
...
},{"../../utils/makeElement":"8ZxEo","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"gfP4p":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _brandingHeader = require("../components/ui/brandingHeader");
var _brandingHeaderDefault = parcelHelpers.interopDefault(_brandingHeader);
// import makeElement from "../utils/makeElement";
const todoPage = function() {
    const pageHeader = document.createElement('header');
    const BrandingHeaderElements = _brandingHeaderDefault.default();
    pageHeader.append(BrandingHeaderElements);
    return pageHeader;
};
exports.default = todoPage;

},{"@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV","../components/ui/brandingHeader":"3pFIn"}],"3pFIn":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const brandingHeader = function() {
    ...
    const h1 = _headerDefault.default('Peace of Cake');
    const tag = _taglineDefault.default("Not As Hard As You Thought");
    const brandLogo = _logoDefault.default("ui-small-logo");
...
},{"../../utils/makeElement":"8ZxEo","./header":"9iGIZ","../icons/logo":"izkzg","./tagline":"lEXnU","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}]},["cSv3F","3auaO"], "3auaO", "parcelRequire66d6")
